...
def test_truncation():
    ...
    truncated = lexianki_rs.truncate_context(long_sentence, target, 50)
    ...
    target_2 = "Remarkable"
    truncated_2 = lexianki_rs.truncate_context(long_sentence_2, target_2, 50)
    ...
    target_3 = "snowstorm"
    truncated_3 = lexianki_rs.truncate_context(long_sentence_3, target_3, 50)
